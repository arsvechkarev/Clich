 ...
 * <p>
 * At minimum, defines item diffing behavior with a {@link DiffUtil.ItemCallback}, used to
 * compute item differences to pass to a RecyclerView adapter.
 *
...
public final class AsyncDifferConfig<T> {
  ...
  public static final class Builder<T> {
    ...
    /**
     * If provided, defines the background executor used to calculate the diff between an
     * old and a new list.
     * <p>
     * If not provided, defaults to two thread pool executor, shared by all
     * ListAdapterConfigs.
     *
